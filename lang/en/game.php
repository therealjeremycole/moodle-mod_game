...
$string['hangman_wrongnum'] = 'Melted: %d out of %d';
...
$string['hangman_loose'] = '<BIG><B>The snowman has melted!</B></BIG>';
$string['html_hangman_new'] = 'New';
$string['hangman_error'] = 'Game Snowman error: %s';
...
$string['helphangman'] = 'This game takes words from either a Glossary or quiz short answer questions and generates a snowman puzzle. Guess the word correctly before the snowman melts into a puddle! Teacher can set the number of words that each game contains, if shows the first or last letter, or if show the question or the answer at the end.';
...
$string['modulename_help'] = 'This module contains 8 games: Snowman, Crossword, Cryptex, Millionaire, Sudoku, The hidden picture, Snakes and Ladders and Book with questions';
...
$string['hangman_imageset'] = 'Select the snowman image style';
...
$string['hangman_options'] = 'Snowman options';
$string['hangman_showcorrectanswer'] = 'Show the correct answer after the end';
$string['hangman_showfirst'] = 'Show first letter of snowman';
$string['hangman_showlast'] = 'Show last letter of snowman';
...
// File settings.php.
$string['hangmanimagesets'] = 'Number of image sets used by snowman';
...
$string['hidehangman'] = 'Hide the Snowman game';
...
$string['confighangmanimagesets'] = 'Configs how many set of images are used by snowman';
...
$string['confighidehangman'] = 'Configs if the Snowman game is shown to teachers or not';
